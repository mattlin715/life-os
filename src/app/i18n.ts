...
export const uiText = {
  en: {
    ...
    patternContextLimited: "There is enough context for observation and reflection, but not yet for a recurring-pattern hypothesis.",
  ...
  "zh-TW": {
    ...
    patternContextLimited: "目前的情境足以整理觀察與反思，但還不足以形成重複模式的假設。",
    patternAria: "Pattern candidate review",
    patternStep: "3 / Pattern",
  ...
  ja: {
    ...
    patternContextLimited: "観察と振り返りには十分ですが、繰り返すパターンの仮説を作るには、まだ文脈が足りません。",
    patternAria: "Pattern candidate review",
    patternStep: "3 / Pattern",
